...
internal static class MathUtilities
{
    ...
    public static Rational GetCommonFactor(Rational[] rationals)
    {
        ...
        var result = new Rational(CombineFactors(upstairs), CombineFactors(downstairs));
        ...
        out BigInteger nthRoot)
    {
        ...
        var root = Rational.Root(value, exponent);
        var rootNearestInteger = (BigInteger)(root + 0.5);
        if (rootNearestInteger.Pow(exponent) == value)
        {
            isPerfectPower = true;
