...
namespace Radicals.Test
{
    public class BasicRadicalTests
    {
        ...
        public void AdditionTests()
        {
            ...
            var actual2 = b21 + b22;
            var expected2 = new CompositeRadical(new BasicRadical[1] { new BasicRadical(3, 2) });
            // 5*sqrt(27) + 7*sqrt(12) = 15*sqrt(3) + 14*sqrt(3) = 29*sqrt(3)
            var b31 = new BasicRadical(5, 27);
            var b32 = new BasicRadical(7, 12);
            var actual3 = b31 + b32;
            var expected3 = new CompositeRadical( new BasicRadical[1] { new BasicRadical(29, 3) });
            // 3*sqrt(2) + 2*sqrt(3)
            ...
            var expected6 = new CompositeRadical(new BasicRadical[1] { new BasicRadical(new Rational(3, 2), 5) });

            // (3/2)*sqrt(5) + (-3/2)*sqrt(5) = 0
            var b71 = new BasicRadical(new Rational(3, 2), 5);
            var b72 = new BasicRadical(new Rational(-3, 2), 5);
            var actual7 = b71 + b72;
            var expected7 = new CompositeRadical(new BasicRadical[1] { BasicRadical.Zero });
        ...
        public void SubtractionTests()
        {
            ...
            var b22 = new BasicRadical(2, 2);
            var actual2 = b21 - b22;
            var expected2 = new CompositeRadical(new BasicRadical[1] { new BasicRadical(-1, 2) });
            // 5*sqrt(27) - 7*sqrt(12) = 15*sqrt(3) - 14*sqrt(3) = 1*sqrt(3)
            var b31 = new BasicRadical(5, 27);
            var b32 = new BasicRadical(7, 12);
            var actual3 = b31 - b32;
            var expected3 = new CompositeRadical(new BasicRadical[1] { new BasicRadical(1, 3) });
            // 3*sqrt(2) - 2*sqrt(3)
            var b41 = new BasicRadical(3, 2);
            var b42 = new BasicRadical(2, 3);
            var actual4 = b41 - b42;
            ...
            var b72 = new BasicRadical(new Rational(3, 2), 5);
            var actual7 = b71 - b72;
            var expected7 = new CompositeRadical(new BasicRadical[1] { new BasicRadical(new Rational(-3, 2), 5) });
            // (3/2)*sqrt(5) - (3/2)*sqrt(5) = 0
            var b81 = new BasicRadical(new Rational(3, 2), 5);
            var b82 = new BasicRadical(new Rational(3, 2), 5);
            var actual8 = b81 - b82;
            var expected8 = new CompositeRadical(new BasicRadical[1] { BasicRadical.Zero });
